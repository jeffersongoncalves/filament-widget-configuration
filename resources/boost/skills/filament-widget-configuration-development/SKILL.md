...
This means a widget that sets its own `protected static ?string $pollingInterval = '10s';` (or the non-static equivalent on Filament 4/5) always keeps `10s`, regardless of the global default.
